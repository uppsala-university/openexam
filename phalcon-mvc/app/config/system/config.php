...
//                )
        ...
        'render'      => array(
                ...
                // 
                'command'   => array(
                        'image' => 'wkhtmltoimage --format png --quality 95 --enable-javascript --javascript-delay 3000',
                        'pdf'   => 'wkhtmltopdf --outline --outline-depth 2 --disable-forms --enable-javascript --javascript-delay 3000'
                )
        ),
        /**
