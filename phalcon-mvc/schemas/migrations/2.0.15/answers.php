...
/**
 * Class AnswersMigration_2015
 */
class AnswersMigration_2015 extends Migration
{
    /**
                ...
                'references' => array(
                    new Reference(
                        ...
                        array(
                            ...
                            'columns' => array('question_id','question_id','question_id','question_id'),
                    ...
                    new Reference(
                        ...
                        array(
                            ...
                            'columns' => array('student_id','student_id','student_id','student_id'),
                            'referencedColumns' => array('id','id','id','id'),
                            'onUpdate' => 'RESTRICT',
                            'onDelete' => 'RESTRICT'
                        )
