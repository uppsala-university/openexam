...
class LockTest extends TestModel
{
        ...
        {
                $object = Lock::findFirstById($this->_sample->getSample(self::MODEL)['id']);
        ...
        /**
         * @covers OpenExam\Models\Lock::create
         * @group model
         */
        ...
        /**
         * @covers OpenExam\Models\Lock::update
         * @group model
         */
        ...
        /**
         * @covers OpenExam\Models\Lock::delete
         * @group model
         */
        ...
        /**
         * @covers OpenExam\Models\Lock::find
         * @group model
         */
