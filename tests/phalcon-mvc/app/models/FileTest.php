...
class FileTest extends TestModel
{
        ...
        {
                $object = File::findFirstById($this->_sample->getSample(self::MODEL)['id']);
        ...
        /**
         * @covers OpenExam\Models\File::create
         * @group model
         */
        ...
        /**
         * @covers OpenExam\Models\File::update
         * @group model
         */
        ...
        /**
         * @covers OpenExam\Models\File::delete
         * @group model
         */
        ...
        /**
         * @covers OpenExam\Models\File::find
         * @group model
         */
