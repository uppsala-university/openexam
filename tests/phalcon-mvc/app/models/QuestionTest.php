...
class QuestionTest extends TestModel
{
        ...
        {
                $object = Question::findFirstById($this->_sample->getSample(self::MODEL)['id']);
        ...
        public function testBehavior()
        {
                ...
                $object = new Question();
                $object->assign($this->_sample->getSample('question', false));
                $object->user = null;
                 ...
                 */
                $exam = new Exam();
                $exam->assign($this->_sample->getSample('exam', false));
                $exam->id = null;
        ...
        public function testQuery()
        {
                ...
                $sample = $this->_sample->getSample(self::MODEL);
