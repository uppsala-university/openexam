...
// 
// File:    StudentAccess.php
// Created: 2014-09-30 14:54:38
// 
...
/**
 * Access control for the Student model.
 * @author Anders Lövgren (Computing Department at BMC, Uppsala University)
 */
class StudentAccess extends ObjectAccess
{
         ...
         * @param Student $model The model object.
        ...
        public function checkObjectAction($action, $model, $user)
        {
                ...
                return $this->trustedContextCall(function($role) use($action, $model, $user) {
                            // 
                            // Deny delete student if answers exist.
                            // 
                            if ($action == self::DELETE && $model->answers->count() > 0) {
                                    throw new Exception("Student having answers can't be deleted", Exception::ACTION);
                            }
